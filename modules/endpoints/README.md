...
| <a name="input_endpoint_allow_cidrs"></a> [endpoint\_allow\_cidrs](#input\_endpoint\_allow\_cidrs) | (Optional) IP CIDR's to allow to reach the Resolver Endpoints | `list(string)` | <pre>[<br>  "10.0.0.0/8"<br>]</pre> | no |
